(function() {
        ...
        Base = {
            ...
            callback: function(editor, $w, url, state) {
                ...
                if (state == "SUCCESS") {
                    ...
                    // can $(".edui-image-content", $w).append($item);
                    // xxxs
    ...
    var Upload = {
        ...
        submit: function(callback) {
            ...
            var projectName = ucConfig.ServerReferenceJavaScript.split("/").reverse()[0];
            // $(me.dialog).delegate(".edui-image-file", "change", function(e) {});
            function upload(){
                $('.edui-image-file', me.dialog).fileupload({
                    url: ucConfig.ServerReferenceFileCenterAPI + "/fileupload/ImgSingleUpload/" + projectName,
                    dataType: 'json',
                    autoUpload: true,
                    ...
                    always: function(e, data) {
                        ...
                        $(".edui-image-file", this.dialog).each(function(index, ele) {
                            ele.parentNode.replaceChild(input.cloneNode(true), ele);
                        });
                        ...
                        // $("#result").empty();
                        // $("#result").append('<img src="' + result.files.files[0].url + '" />');
                    },
    ...
    UM.registerWidget('image', {
        tpl: "<link rel=\"stylesheet\" type=\"text/css\" href=\"<%=image_url%>image.css\">" +
            ...
            "<div class=\"edui-image-dragTip\">点击图标上传图片</div>" +
            "</div>" +
