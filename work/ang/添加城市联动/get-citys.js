 ...
 * @Last Modified time: 2016-11-15 18:35:09
 */
angular.module('RegisterFormModule').factory('getProvince', function() {
    var getProvinceOpt = {
        "type": "get",
...
angular.module('RegisterFormModule').factory('getCity', function() {
    return function(pid) {
        var getCityOpt = {
            "type": "get",
            "webUrl": ucConfig.ServerReferenceSystemAdminAPI,
...
angular.module('RegisterFormModule').factory('getAre', function() {
    return function(cid) {
        var getAreaOpt = {
            "type": "get",
            "webUrl": ucConfig.ServerReferenceSystemAdminAPI,
