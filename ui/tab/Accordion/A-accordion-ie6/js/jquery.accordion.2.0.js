        ...
        this.each(function() {
            var accordion = $(this),
                ...
                panels = accordion.find(">li>" + defaults.panel)
                    .each(function() {
                        var el = $(this);
                        el.removeClass(defaults.loadingClass)
                            ...
                            .bind("panel-open.accordion", function(e, clickedLi) {
                                ...
                                panel
                                    ...
                                    .show()
                                    .animate($.browser.msie && parseInt($.browser.version) < 8 ? panel.data("dimensions") : $.extend({
                                        opacity: 1
            ...
            accordion
                .find(
                    " > li." + defaults.activeClassLi + " > " + defaults.panel + ", > li." + defaults.lockedClass + " > " + defaults.panel
            )
                .show()
                .addClass(defaults.activeClassPanel);

            var active = accordion.find(
                " > li." + defaults.activeClassLi + ", > li." + defaults.lockedClass
            );
            ...
            accordion.delegate(".accordion-opener", "click", function(e) {
                ...
                var clicked = $(this),
                    ...
                    open = accordion.find(
                        " > li:not(." + defaults.lockedClass + ") > " + defaults.panel + "." + defaults.activeClassPanel
                    );
