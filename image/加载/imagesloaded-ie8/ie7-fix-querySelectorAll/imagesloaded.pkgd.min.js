...
if(typeof elem==='string'){if($.browser.version<8&&$.browser.msie){elem=document.documentElement.querySelectorAll(elem);}else{elem=document.querySelectorAll(elem);}}
...
var childElems;if($.browser.version<8&&$.browser.msie){childElems=document.documentElement.querySelectorAll('img');}else{childElems=elem.querySelectorAll('img');}
for(var j=0,jLen=childElems.length;j<jLen;j++){var img=childElems[j];this.addImage(img);}}};ImagesLoaded.prototype.addImage=function(img){var loadingImage=new LoadingImage(img);this.images.push(loadingImage);};ImagesLoaded.prototype.check=function(){var _this=this;var checkedCount=0;var length=this.images.length;this.hasAnyBroken=false;if(!length){this.complete();return;}
